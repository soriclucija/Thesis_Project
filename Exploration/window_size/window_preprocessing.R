...
window_width <- 60 #change values to adjust window size (e.g., 5, 10, 20)
step_size    <- 18 #change values to adjust step size 
n_trials     <- 600
...
write.csv(fa_windows_df, "C:/Users/lucij/Desktop/Leiden/Year 2/Thesis Project/2024_data/window_sizes/w60_s18_preprocessing.csv", row.names = FALSE) #change name for easy identification

cat("Saved to w60_s18_preprocessing.csv\n") #not necessary but good for confirmation